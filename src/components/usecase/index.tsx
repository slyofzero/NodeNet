    ...
    <div className="my-10">
      <div className="bg-[#1c1c1c87] rounded-2xl md:h-[701px] h-[600px] px-4 flex flex-col justify-center items-center mt-10">
        <h1 className="md:text-[48px] text-[36px] font-extrabold gradient-text text-center ">
          Nimbus brings <br /> Decentralization to Cloud Computing.
        </h1>
        <p className="text-lg mt-3 md:px-48 px-0 text-center">
          By leveraging the newfound possibilities of DePIN (Decentralized
          Physical Infrastructure Networks), Nimbus offers unparalleled access
          ...
          $USDC, $BTC, and more through Nimbus services and receive your
